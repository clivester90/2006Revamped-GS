...
public class UseItem {
	...
	public static void itemOnItem(Player player, int itemUsed, int useWith) {
		...
		if (itemUsed == 771 && useWith == 946
				&& player.playerLevel[SkillData.CRAFTING.getId()] > 30) {
			player.getItemAssistant().deleteItem(771, 1);
			player.getItemAssistant().addItem(772, 1);
		} else if (player.playerLevel[SkillData.CRAFTING.getId()] < 31 && itemUsed == 771
				&& useWith == 946) {
		...
		if (itemUsed == 946 && useWith == 771
			...
			player.getItemAssistant().deleteItem(771, 1);
			player.getItemAssistant().addItem(772, 1);
		} else if (player.playerLevel[SkillData.CRAFTING.getId()] < 31 && itemUsed == 946
				&& useWith == 771) {
			player.getPacketSender().sendMessage(
					"You need 31 crafting to make this.");
		}
		...
		for (int firemakingItem : firemakingItems) {
			if (itemUsed == firemakingItem || useWith == firemakingItem && !player.isFiremaking) {
				Firemaking.attemptFire(player, itemUsed, useWith, player.absX, player.absY, false);
			} else if (itemUsed == firemakingItem || useWith == firemakingItem && player.isFiremaking) {
		...
		if (itemUsed == 1095 && useWith == 2370 || itemUsed == 2370
				&& useWith == 1095 && player.playerLevel[SkillData.CRAFTING.getId()] > 43) {// chaps
			player.getItemAssistant().deleteItem(2370, 1);
			player.getItemAssistant().deleteItem(1095, 1);
			player.getItemAssistant().addItem(1097, 1);
			player.getPlayerAssistant().addSkillXP(42, SkillData.CRAFTING.getId());
		} else if (itemUsed == 1095 && useWith == 2370 || itemUsed == 2370 && useWith == 1095 && player.playerLevel[SkillData.CRAFTING.getId()] < 44) {
		...
		if (itemUsed == 1129 && useWith == 2370 || itemUsed == 2370 && useWith == 1129 && player.playerLevel[SkillData.CRAFTING.getId()] > 40) {// body
			player.getItemAssistant().deleteItem(2370, 1);
			player.getItemAssistant().deleteItem(1129, 1);
			player.getItemAssistant().addItem(1133, 1);
			player.getPlayerAssistant().addSkillXP(40, SkillData.CRAFTING.getId());
		} else if (itemUsed == 1129 && useWith == 2370 || itemUsed == 2370 && useWith == 1129 && player.playerLevel[SkillData.CRAFTING.getId()] < 41) {
