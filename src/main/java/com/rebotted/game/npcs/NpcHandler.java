...
public class NpcHandler {
    ...
    public void loadNPCList() {
        ...
        try {
            Type collectionType = new TypeToken<com.rebotted.util.NpcData[]>() {
            }.getType();
            com.rebotted.util.NpcData[] data = gson.fromJson(new FileReader("./data/cfg/npc.json"), collectionType);

            for (com.rebotted.util.NpcData npc : data) {
