...
public class QuestRewards {
	...
	public static void questReward(Player player, String questName, String Line1, String Line2, String Line3, String Line4, String Line5, String Line6, int itemID) {
		...
		player.getPacketSender().sendString(String.valueOf(player.questPoints), 12147);
	...
	public static void knightsReward(Player player) {
		...
		player.getPlayerAssistant().addSkillXP(12725, SkillData.SMITHING.getId());
		player.questPoints ++;
		player.knightS = 9;
	}
	...
	public static void gertFinish(Player player) {
		...
		player.getPlayerAssistant().addSkillXP(1525, SkillData.COOKING.getId());
		player.questPoints++;
		player.gertCat = 7;
	}
	...
	public static void witchFinish(Player client) {
		...
		client.getPlayerAssistant().addSkillXP(325, SkillData.MAGIC.getId());
		client.questPoints++;
		client.witchspot = 3;
	}
	...
	public static void restFinish(Player client) {
		...
		client.getPlayerAssistant().addSkillXP(125, SkillData.PRAYER.getId());
		client.questPoints++;
		client.restGhost = 5;
	}
	...
	public static void vampFinish(Player player) {
		...
		player.getPlayerAssistant().addSkillXP(4825, SkillData.ATTACK.getId());
	...
	public static void sheepFinish(Player player) {
		...
		player.getPlayerAssistant().addSkillXP(150, SkillData.CRAFTING.getId());
		player.questPoints++;
		player.sheepShear = 2;
	}
	...
	public static void doricFinish(Player player) {
		...
		player.getPlayerAssistant().addSkillXP(1300, SkillData.MINING.getId());
		player.questPoints++;
		player.doricQuest = 3;
	}
	...
	public static void impFinish(Player player) {
		...
		player.getPlayerAssistant().addSkillXP(875, SkillData.MAGIC.getId());
		player.questPoints++;
		player.impsC = 2;
	}
	...
	public static void cookReward(Player player) {
		...
		player.getPlayerAssistant().addSkillXP(300, SkillData.COOKING.getId());
		player.questPoints++;
		player.cookAss = 3;
	}
