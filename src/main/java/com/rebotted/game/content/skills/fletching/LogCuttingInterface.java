...
public class LogCuttingInterface {
	...
	public static void fletchInterface(Player c, int item) {
		...
		if (item == 1511) {
			...
			c.getPacketSender().sendInterfaceModel(8883, 180, 52); // left
			c.getPacketSender().sendInterfaceModel(8884, 180, 50); // middle
			c.getPacketSender().sendInterfaceModel(8885, 180, 48); // right
			...
			c.getPacketSender().sendString("What would you like to make?", 8879);
			c.getPacketSender().sendInterfaceModel(8869, 180, 54); // left
			c.getPacketSender().sendInterfaceModel(8870, 180, 56); // right
			...
			c.getPacketSender().sendChatInterface(8866);
			c.getPacketSender().sendString("What would you like to make?", 8879);
			c.getPacketSender().sendInterfaceModel(8869, 180, 60); // left
			c.getPacketSender().sendInterfaceModel(8870, 180, 58); // right
			...
			c.getPacketSender().sendChatInterface(8866);
			c.getPacketSender().sendString("What would you like to make?", 8879);
			c.getPacketSender().sendInterfaceModel(8869, 180, 64); // left
			c.getPacketSender().sendInterfaceModel(8870, 180, 62); // right
			...
			c.getPacketSender().sendChatInterface(8866);
			c.getPacketSender().sendString("What would you like to make?", 8879);
			c.getPacketSender().sendInterfaceModel(8869, 180, 68); // left
			c.getPacketSender().sendInterfaceModel(8870, 180, 66); // right
			...
			c.getPacketSender().sendChatInterface(8866);
			c.getPacketSender().sendString("What would you like to make?", 8879);
			c.getPacketSender().sendInterfaceModel(8869, 180, 72); // left
			c.getPacketSender().sendInterfaceModel(8870, 180, 70); // right
