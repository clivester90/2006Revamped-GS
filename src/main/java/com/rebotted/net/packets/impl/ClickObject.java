	...
	public void completeObjectClick(final Player player, int objectOption) {
		...
		case 1:
			...
			case 1292: //lostCity 1
				if (!player.spiritTree && player.clickedTree && player.lostCity < 2)
				{
			...
			case 2409://lostCity 2
				...
				else if (player.lostCity == 1 && !player.leprechaunSpawned) {
				...
				else if (player.lostCity >= 2 && !player.leprechaunSpawned) {
